 ...
 * </ul>
 * Created by r14676 on 2018/4/27.
 */
public class UUIDUtils {
    ...
    private static int UUID_VERSION = 1;    // uuid version 1
     ...
     * @return
     */
    public static int getMonthByUUID(String uuidStr) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeInMillis(getTimestampByUUID(uuidStr));
     ...
     * @return
     */
    public static int getWeekByUUID(String uuidStr) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeInMillis(getTimestampByUUID(uuidStr));
        return calendar.get(Calendar.WEEK_OF_YEAR); // 按年取周
    }
     ...
     * @return
     */
    public static long getTimestampByUUID(String uuidStr) {
        String[] array = {
                "0x" + uuidStr.substring(7, 15),
                "0x" + uuidStr.substring(3, 7),
                "0x" + UUID_VERSION + uuidStr.substring(0, 3),    // version 1
        };

        long mostSigBits = timeStrToLong(array);
        return ((mostSigBits & 0x0FFFL) << 48
                | ((mostSigBits >> 16) & 0x0FFFFL) << 32
                | mostSigBits >>> 32) / 10000L + START_EPOCH;
    }

    public static long timeStrToLong(String[] components) {
